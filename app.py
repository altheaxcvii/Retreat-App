...
if st.session_state.currentstage >= 1:
    with st.expander('You may need this 😊'):
        ...
        st.write(f"If you're stuck on this stage for over 10 minutes, contact Eza/Hasanah/Hannah/Althea for help and quote station {st.session_state.currentstage}")
